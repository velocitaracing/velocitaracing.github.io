$("#close-process").click(function(){
    ...
    $(".slab-1").click(function(){
        ...
        document.getElementById("text").value = "upi://pay?cu=INR&pa=satvikcrvk718-1@oksbi&pn=Satvik S.&am=100&tn=Velocita%20Racing%20Crowdfunding%201CENGINE&aid=uGICAgICNoKyPZw";
        ...
        $("#mobile-upi").attr("href", "upi://pay?cu=INR&pa=satvikcrvk718-1@oksbi&pn=Satvik S.&am=100&tn=Velocita%20Racing%20Crowdfunding%201cENGINE&aid=uGICAgICNoKyPZw")
    ...
    $(".slab-2").click(function(){
        ...
        document.getElementById("text").value = "upi://pay?cu=INR&pa=satvikcrvk718-1@oksbi&pn=Satvik S.&am=500&tn=Velocita%20Racing%20Crowdfunding%20V2V-TWIN&aid=uGICAgICNoKyPZw"
        $("#mobile-upi").attr("href", "upi://pay?cu=INR&pa=satvikcrvk718-1@oksbi&pn=Satvik S.&am=500&tn=Velocita%20Racing%20Crowdfunding%20V2V-TWIN&aid=uGICAgICNoKyPZw")
    ...
    $(".slab-3").click(function(){
        ...
        document.getElementById("text").value = "upi://pay?cu=INR&pa=satvikcrvk718-1@oksbi&pn=Satvik S.&am=1000&tn=Velocita%20Racing%20Crowdfunding%20I3-INLINE-3&aid=uGICAgICNoKyPZw"
        $("#mobile-upi").attr("href", "upi://pay?cu=INR&pa=satvikcrvk718-1@oksbi&pn=Satvik S.&am=1000&tn=Velocita%20Racing%20Crowdfunding%20I3-INLINE-3&aid=uGICAgICNoKyPZw")
    ...
    $(".slab-4").click(function(){
        ...
        document.getElementById("text").value = "upi://pay?cu=INR&pa=satvikcrvk718-1@oksbi&pn=Satvik S.&am=1500&tn=Velocita%20Racing%20Crowdfunding%20I4-INLINE-4&aid=uGICAgICNoKyPZw"
        $("#mobile-upi").attr("href", "upi://pay?cu=INR&pa=satvikcrvk718-1@oksbi&pn=Satvik S.&am=1500&tn=Velocita%20Racing%20Crowdfunding%20I4-INLINE-4&aid=uGICAgICNoKyPZw")
    ...
    $(".slab-5").click(function(){
        ...
        document.getElementById("text").value = "upi://pay?cu=INR&pa=satvikcrvk718-1@oksbi&pn=Satvik S.&am=3000&tn=Velocita%20Racing%20Crowdfunding%20V6-Engine&aid=uGICAgICNoKyPZw"
        $("#mobile-upi").attr("href", "upi://pay?cu=INR&pa=satvikcrvk718-1@oksbi&pn=Satvik S.&am=3000&tn=Velocita%20Racing%20Crowdfunding%20V6-Engine&aid=uGICAgICNoKyPZw")
    ...
    $(".slab-6").click(function(){
        ...
        document.getElementById("text").value = "upi://pay?cu=INR&pa=satvikcrvk718-1@oksbi&pn=Satvik S.&am=5000&tn=Velocita%20Racing%20Crowdfunding%20V8-Engine&aid=uGICAgICNoKyPZw"
        $("#mobile-upi").attr("href", "upi://pay?cu=INR&pa=satvikcrvk718-1@oksbi&pn=Satvik S.&am=5000&tn=Velocita%20Racing%20Crowdfunding%20V8-Engine&aid=uGICAgICNoKyPZw")
    ...
    $(".slab-7").click(function(){
        ...
        $("#edit-money").css({'display': 'none'});
        document.getElementById("text").value = "upi://pay?cu=INR&pa=satvikcrvk718-1@oksbi&pn=Satvik S.&am=10000&tn=Velocita%20Racing%20Crowdfunding%20V12-Engine&aid=uGICAgICNoKyPZw"
        $("#mobile-upi").attr("href", "upi://pay?cu=INR&pa=satvikcrvk718-1@oksbi&pn=Satvik S.&am=1000&tn=Velocita%20Racing%20Crowdfunding%20V12-Engine&aid=uGICAgICNoKyPZw")
    ...
    $(".slab-8").click(function(){
        ...
        $("#proceed-step-three").click (function() {
          ...
          document.getElementById("text").value = "upi://pay?cu=INR&pa=satvikcrvk718-1@oksbi&pn=Satvik S.&am="+ nameValue + "&aid=uGICAgICNoKyPZw&tn=Velocita%20Racing%20Crowdfunding%20Slab" + amtValue
          $("#mobile-upi").attr("href", "upi://pay?cu=INR&pa=satvikcrvk718-1@oksbi&pn=Satvik S.&am=" + nameValue + "&aid=uGICAgICNoKyPZw&tn=Velocita%20Racing%20Crowdfunding%20Slab" + amtValue);
        });
